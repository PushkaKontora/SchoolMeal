import {TableContainer, Title} from './styles.ts';
...
import {MealRowData} from '../types/meal-row-data.ts';
import {transformRequestReport} from '../lib/utils.ts';
import {BREAKFAST_TITLE, DINNER_TITLE, LUNCH_TITLE} from '../consts/titles.ts';
import HeaderTeacherWidget from '../../header-teacher/ui/header-teacher.tsx';
import {TITLE} from '../config/config.ts';
