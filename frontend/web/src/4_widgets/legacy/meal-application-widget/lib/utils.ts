import {Meal} from '../../../../6_entities/meals/model/meal.ts';
import {MealRowData} from '../types/meal-row-data.ts';
import {Class} from '../../../../6_entities/meals/model/class-view.ts';
import {Pupil} from '../../../../6_entities/meals/model/pupil-view.ts';
import {MealCellData} from '../../../../5_features/meals/meal-info-table/types.ts';
import {MealRowValue} from '../types/meal-row-value.ts';
