...
from app.legacy.pupils.domain.entities import PupilOut
from app.legacy.pupils.domain.services import get_pupils_by_class_id
from app.legacy.school_classes.domain.entities import ClassWithSchoolOut, SchoolClassesGetOptions
from app.legacy.school_classes.domain.services import get_school_classes_by_options
